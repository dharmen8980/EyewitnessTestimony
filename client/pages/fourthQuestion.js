...
import { FourthQn } from "../components/data/fourthQn";

const FourthQuestion = ({questionNumber, setQuestionNumber, response}) => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const maxOption = FourthQn.length;
  ...
  return (questionNumber == 4 ? showVideo ? (
    <>
    <Head>
    ...
    <div className="my-16 bg-yellow-500 p-1 w-fit mx-auto">
      <div className="bg-[#660000] m-1 w-fit">
        ...
        <div className="text-white w-fit text-xl text-center mx-auto p-10">
          <p>{FourthQn[counter].name}</p>
          <img
            src={FourthQn[counter].src}
            alt="image"
            className="mx-auto h-[400px] w-[400px]"
          />
          <p className="my-4">Was this the person you saw in the video?</p>
          <label>
            <input type="radio" name={FourthQn[counter].name} value="yes" className="mr-2" onChange={onHandleChange}/>
            Yes
          </label>
          <label className="ml-6">
            <input type="radio" name={FourthQn[counter].name} value="no" className="mr-2" onChange={onHandleChange} />
            No
          </label>
        </div>
      </div>
          ...
          <div className="text-white text-center p-6">
            ...
            <div className="w-fit mx-auto">
              <input
                ...
                min="1"
                max="10"
                name={FourthQn[counter].confidence}
