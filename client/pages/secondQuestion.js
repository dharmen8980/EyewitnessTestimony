...
import { SecondQn } from "../components/data/secondQn";

const SecondQuestion = ({ questionNumber, setQuestionNumber, response }) => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const maxOption = SecondQn.length;
  ...
  return questionNumber == 2 ? showVideo ? (
    <>
      <Head>
      ...
      <div className="my-16 bg-yellow-500 p-1 w-fit mx-auto">
        <div className="bg-[#660000] m-1 w-fit">
          ...
          <div className="text-white w-fit text-xl text-center mx-auto p-10">
            <p>{SecondQn[counter].name}</p>
            <img
              src={SecondQn[counter].src}
              alt="image"
            ...
            <div className="text-white text-center p-6">
              ...
              <div className="w-fit mx-auto">
                <input
                  ...
                  min="1"
                  max="10"
                  name={SecondQn[counter].confidence}
                  onChange={onHandleChange}
                  className="w-[540px]"
                />
              </div>
